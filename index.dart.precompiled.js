...
$isiP:true,
static:{"^":"Oj,Vp,Ej,p2,ch,QC,nm,Yp,kc,Gi,Fz,cR,E0,Ke,Cg,Nr,Dk,FI,Kz,ek,yf,Fk",Wu:function(a,b){var z=new P.iP(a,b)
z.RM(a,b)
...
VO:{
"^":"Tp:28;",
$1:[function(a){return a.Lt()},"$1",null,2,0,null,55,"call"],
$isEH:true},
oP:{
"^":"Tp:28;",
$1:[function(a){return J.C0(a,new E.kJ()).br(0)},"$1",null,2,0,null,56,"call"],
$isEH:true},
kJ:{
"^":"Tp:28;",
$1:[function(a){return a.Lt()},"$1",null,2,0,null,55,"call"],
...
w.appendChild(n)}}t=new E.Mg(v)
r=new E.jN(w)
m=new E.yU(z,t,r)
l=J.Vg(document.querySelector("#runVDomDart"))
H.VM(new W.xC(0,l.J6,l.fA,W.VF(new E.jr(new E.Nt(z,y,t,r))),l.el),[H.Kp(l,0)]).DN()
l=J.Vg(document.querySelector("#runReactJs"))
H.VM(new W.xC(0,l.J6,l.fA,W.VF(new E.ql(m)),l.el),[H.Kp(l,0)]).DN()
l=J.Vg(document.querySelector("#runMithrilJs"))
H.VM(new W.xC(0,l.J6,l.fA,W.VF(new E.N2(m)),l.el),[H.Kp(l,0)]).DN()
l=J.Vg(document.querySelector("#runVirtualDomJs"))
H.VM(new W.xC(0,l.J6,l.fA,W.VF(new E.uI(m)),l.el),[H.Kp(l,0)]).DN()},"$1",null,2,0,null,39,"call"],
$isEH:true},
Mg:{
"^":"Tp:28;c",
$1:function(a){var z=this.c
...
z.$1(!0)
return P.dT(P.k5(0,0,0,0,0,0),null,null).ml(new E.Et(this.e,this.f,this.bK,a,b)).ml(new E.Vv(z))},
$isEH:true},
Et:{
"^":"Tp:28;Gq,Rm,w3,HZ,mG",
$1:[function(a){var z={}
z.a=0
return P.lQ(this.Gq.hR,new E.O4(z,this.Rm,this.w3,this.HZ,this.mG))},"$1",null,2,0,null,39,"call"],
$isEH:true},
O4:{
"^":"Tp:28;a,xC,cj,jk,i0",
$1:function(a){var z,y
z=this.i0.$3(J.Mh(a),a.gb(),this.xC)
y=this.a
this.cj.$3(this.jk,y.a,z);++y.a
return P.dT(P.k5(0,0,0,0,0,0),null,null)},
$isEH:true},
Vv:{
"^":"Tp:28;r",
$1:[function(a){this.r.$1(!1)},"$1",null,2,0,null,39,"call"],
$isEH:true},
yU:{
"^":"Tp:28;YC,Pz,Of",
$1:function(a){var z=this.Pz
z.$1(!0)
return P.dT(P.k5(0,0,0,0,0,0),null,null).ml(new E.CF(this.YC,this.Of,a)).ml(new E.ZX(z))},
$isEH:true},
CF:{
"^":"Tp:28;Fc,ES,x",
$1:[function(a){var z={}
z.b=0
return P.lQ(this.Fc.hR,new E.JF(z,this.ES,this.x))},"$1",null,2,0,null,39,"call"],
$isEH:true},
JF:{
"^":"Tp:28;b,y,z",
$1:function(a){var z,y,x,w
...
w=J.U6(x)
this.y.$3(z,y.b,new E.oe(w.t(x,"renderTime"),w.t(x,"updateTime")));++y.b
return P.dT(P.k5(0,0,0,0,0,0),null,null)},
$isEH:true},
ZX:{
"^":"Tp:28;Sv",
$1:[function(a){this.Sv.$1(!1)},"$1",null,2,0,null,39,"call"],
$isEH:true},
jr:{
"^":"Tp:28;pt",
$1:[function(a){this.pt.$2("VDom",new E.Ws())},"$1",null,2,0,null,39,"call"],
$isEH:true},
Ws:{
"^":"Tp:57;",
...
ql:{
"^":"Tp:28;U9",
$1:[function(a){this.U9.$1("React")},"$1",null,2,0,null,39,"call"],
$isEH:true},
N2:{
"^":"Tp:28;T4",
$1:[function(a){this.T4.$1("Mithril")},"$1",null,2,0,null,39,"call"],
$isEH:true},
uI:{
"^":"Tp:28;yL",
$1:[function(a){this.yL.$1("VirtualDom")},"$1",null,2,0,null,39,"call"],
$isEH:true}},1],["","",,F,{
"^":"",
...
y=Array(z)
for(x=0;x<z;++x)y[x]=x
return new F.M1(a,y,null,null,null,null,null)}else if(a.length===1&&z.gB(b)===1){w=C.Nm.gtH(a)
v=z.gtH(b)
z=J.Cf(w)
u=J.Cf(v)
...
return new F.M1([a[0]],[0],null,[v],[0],null,null)}else if(a.length===1){w=C.Nm.gtH(a)
s=[]
r=[]
u=J.RE(w)
x=0
...
y=[0]
m=null
l=null}return new F.M1(k,y,null,s,r,m,l)}else if(z.gB(b)===1){v=z.gtH(b)
k=[]
y=[]
z=J.RE(v)
x=0
...
XE:{
"^":"Tp:28;",
$1:[function(a){return J.C0(a,new S.If()).br(0)},"$1",null,2,0,null,59,"call"],
$isEH:true},
If:{
"^":"Tp:28;",
$1:[function(a){return a.Lt()},"$1",null,2,0,null,55,"call"],
...
return},"$1",null,2,0,null,58,"call"],
$isEH:true},
W6:{
"^":"Tp:28;",
$1:[function(a){return S.dc(a,1)},"$1",null,2,0,null,58,"call"],
$isEH:true},
Md:{
"^":"Tp:28;",
$1:[function(a){return S.zw(a,1)},"$1",null,2,0,null,58,"call"],
$isEH:true},
YJ:{
"^":"Tp:28;",
$1:[function(a){return S.PW(a,1)},"$1",null,2,0,null,58,"call"],
$isEH:true},
AQ:{
"^":"Tp:28;a",
...
z.push(new F.cv("span",null,null,null,[new F.Un(J.AG(w.gPq(v)),0)],u))}++x}return z},
PY:{
"^":"f6;a>,b<,Z9,bq,VR",
...
init.metadata=["object","sender","e","closure","isolate","numberOfArguments","arg1","arg2","arg3","arg4",{func:"n9",void:true,args:[{func:"X0",void:true}]},{func:"X0",void:true},{func:"G5",void:true,args:[null]},"value",{func:"Vx",void:true,args:[null],opt:[P.mE]},,"error","stackTrace",{func:"Ib",ret:P.a2,args:[null,null]},{func:"bX",ret:P.KN,args:[null]},"a",{func:"Dl",ret:P.KN,args:[P.fR,P.fR]},{func:"E0",ret:P.a2,args:[P.a,P.a]},{func:"ZY",ret:P.KN,args:[P.a]},"callback","captureThis","self","arguments",{func:"aB",args:[null]},"o",{func:"uJ",ret:P.a,args:[null]},{func:"nE",void:true,args:[[P.zM,S.uH]]},"children",{func:"cH",ret:P.KN},{func:"NT"},{func:"bh",args:[null,null]},{func:"uO",args:[P.qU]},{func:"Za",args:[P.qU,null]},{func:"TS",args:[null,P.qU]},"_",{func:"xO",args:[{func:"X0",void:true}]},{func:"zk",args:[P.a2]},{func:"BG",args:[null],opt:[null]},{func:"Uf",ret:P.a2},"ignored","element","data",{func:"bb",args:[null,P.mE]},{func:"N5",void:true,args:[null,P.mE]},"arg","each",{func:"lv",args:[P.wv,null]},{func:"Pt",ret:P.qU,args:[P.KN]},{func:"ZH",args:[P.KN]},{func:"iR",args:[P.KN,null]},"i","k",{func:"cq",args:[null,null,null]},"c","l","g","t","n",];$=null
...
if($desc instanceof Array)$desc=$desc[1]
VW.prototype=$desc
function Mg(c){this.c=c}Mg.builtin$cls="Mg"
if(!"name" in Mg)Mg.name="Mg"
$desc=$collectedClasses.Mg
if($desc instanceof Array)$desc=$desc[1]
Mg.prototype=$desc
function jN(d){this.d=d}jN.builtin$cls="jN"
if(!"name" in jN)jN.name="jN"
$desc=$collectedClasses.jN
if($desc instanceof Array)$desc=$desc[1]
jN.prototype=$desc
function Nt(e,f,UI,bK){this.e=e
this.f=f
this.UI=UI
this.bK=bK}Nt.builtin$cls="Nt"
if(!"name" in Nt)Nt.name="Nt"
$desc=$collectedClasses.Nt
if($desc instanceof Array)$desc=$desc[1]
Nt.prototype=$desc
function Et(Gq,Rm,w3,HZ,mG){this.Gq=Gq
this.Rm=Rm
this.w3=w3
this.HZ=HZ
this.mG=mG}Et.builtin$cls="Et"
if(!"name" in Et)Et.name="Et"
$desc=$collectedClasses.Et
if($desc instanceof Array)$desc=$desc[1]
Et.prototype=$desc
function O4(a,xC,cj,jk,i0){this.a=a
this.xC=xC
this.cj=cj
this.jk=jk
this.i0=i0}O4.builtin$cls="O4"
if(!"name" in O4)O4.name="O4"
$desc=$collectedClasses.O4
if($desc instanceof Array)$desc=$desc[1]
O4.prototype=$desc
function Vv(r){this.r=r}Vv.builtin$cls="Vv"
if(!"name" in Vv)Vv.name="Vv"
$desc=$collectedClasses.Vv
if($desc instanceof Array)$desc=$desc[1]
Vv.prototype=$desc
function yU(YC,Pz,Of){this.YC=YC
this.Pz=Pz
this.Of=Of}yU.builtin$cls="yU"
if(!"name" in yU)yU.name="yU"
$desc=$collectedClasses.yU
if($desc instanceof Array)$desc=$desc[1]
yU.prototype=$desc
function CF(Fc,ES,x){this.Fc=Fc
this.ES=ES
this.x=x}CF.builtin$cls="CF"
if(!"name" in CF)CF.name="CF"
$desc=$collectedClasses.CF
if($desc instanceof Array)$desc=$desc[1]
CF.prototype=$desc
function JF(b,y,z){this.b=b
this.y=y
this.z=z}JF.builtin$cls="JF"
if(!"name" in JF)JF.name="JF"
$desc=$collectedClasses.JF
if($desc instanceof Array)$desc=$desc[1]
JF.prototype=$desc
function ZX(Sv){this.Sv=Sv}ZX.builtin$cls="ZX"
if(!"name" in ZX)ZX.name="ZX"
$desc=$collectedClasses.ZX
if($desc instanceof Array)$desc=$desc[1]
ZX.prototype=$desc
function jr(pt){this.pt=pt}jr.builtin$cls="jr"
...
if($desc instanceof Array)$desc=$desc[1]
Ws.prototype=$desc
function ql(U9){this.U9=U9}ql.builtin$cls="ql"
if(!"name" in ql)ql.name="ql"
$desc=$collectedClasses.ql
if($desc instanceof Array)$desc=$desc[1]
ql.prototype=$desc
function N2(T4){this.T4=T4}N2.builtin$cls="N2"
if(!"name" in N2)N2.name="N2"
$desc=$collectedClasses.N2
if($desc instanceof Array)$desc=$desc[1]
N2.prototype=$desc
function uI(yL){this.yL=yL}uI.builtin$cls="uI"
if(!"name" in uI)uI.name="uI"
$desc=$collectedClasses.uI
if($desc instanceof Array)$desc=$desc[1]
uI.prototype=$desc
...
function Un(nU,Pq){this.nU=nU
this.Pq=Pq}Un.builtin$cls="Un"
if(!"name" in Un)Un.name="Un"
$desc=$collectedClasses.Un
if($desc instanceof Array)$desc=$desc[1]
Un.prototype=$desc
Un.prototype.gnU=function(receiver){return this.nU}
...
return[qE,Gh,rK,F6,LL,fY,Mr,lJ,ct,nB,it,Az,QP,IF,n6,Ny,nx,QQ,MA,y4,TR,Um,oJ,DG,mN,vH,xO,qs,Em,NW,rV,Wy,QF,Ec,cm,Nh,h4,Al,hY,ea,PZ,zZ,as,hH,Aa,u5,Yu,H2,iG,jP,FO,xf,xn,Vb,QH,ST,X2,tb,Sg,pA,Mi,KD,Ln,HL,In,wP,eP,AL,Og,M6,El,mC,SV,aB,fJ,Ih,D8,Vh,rC,ZY,cx,Ee,Qb,PG,F3,xI,Aj,oU,Q0,eY,KV,BH,KY,G7,l9,Ql,wL,bP,mX,SN,HD,fD,nU,ni,rR,qj,nC,KR,ew,Mw,fs,M9,A6,ip,Mx,j2,Ea,lp,kd,I0,yN,Cp,zD,vt,KK,ii,fq,i9,UK,GI,Tb,Iv,BT,fX,oa,FB,xV,FH,y6,RH,Kn,Z2,OR,BR,vw,aG,J6,K5,Xg,UM,YC,hq,NL,yp,Eh,Mq,nK,Nc,rj,rh,Zv,Q7,hF,yK,Dh,ZJ,mU,ph,Bg,JY,Pq,kx,nV,Kg,ui,D6,Bn,Sm,dx,QU,es,jw,bd,pf,nQ,W1,HC,wf,TC,ih,Nd,zp,Xu,lu,v6,me,oB,Ah,yu,MI,Ub,bM,eW,Qy,ju,OE,N9,BA,d0,tp,rE,CC,PQ,uz,Yd,p8,AD,Gr,tc,GH,To,NJ,qI,Pu,rQ,Lx,d5,hy,r8,aS,CG,Kf,jk,Rk,Eo,Pe,o4,GR,rD,cu,BD,yi,Ja,We,cB,LQ,yR,HP,fa,l4,Il,np,Pi,qO,xt,cO,P0,xl,Xr,Sl,Qm,bf,ET,df,zU,K8,xj,dE,ZA,aH,nl,eE,V6,FK,Gv,kn,YE,Ue,iC,is,Q,no,P,bU,VA,O,PK,JO,f0,aX,NY,cC,RA,IY,JH,jl,vK,Iy,JM,Ua,ns,yo,Bj,NO,II,m3,X1,HU,oo,OW,Tf,iY,yH,FA,Av,iV,LI,FD,Nv,Cj,u8,Zr,W0,az,vV,Am,XO,dr,TL,KX,uZ,OQ,Tp,Bp,v,Eq,lb,tD,hJ,dC,wN,VX,aL,bX,a7,i1,xy,MH,A8,U5,SO,TN,Lj,iK,GD,th,ha,C6,Ft,O6,b8,Z5,nu,DQ,Px,Ky,vs,da,pV,U7,rH,eX,ZL,rq,RW,YP,jZ,FZ,OM,qh,lz,Rl,Jb,M4,B5,PI,Dy,lv,lU,xp,UH,D0,MO,nP,KA,x1,qB,aA,LV,DS,dp,B3,CR,Qk,dR,uR,QX,YR,fB,c9,OH,m0,pK,R8,hj,MK,pQ,FG,k6,oi,DJ,PL,fG,EQ,YB,a1,S9,db,i5,N6,b6,tj,zQ,u3,mW,LU,E9,lD,LG,Sw,KG,Ma,Yw,Y2,CL,a2,fR,iP,CP,a6,P7,DW,Ge,LK,AT,bJ,JS,ub,ds,lj,UV,VS,t7,HG,eV,kM,KN,An,zM,c8,lf,a,mE,qU,Rn,wv,BV,id,VG,zL,ec,e7,hm,x5,nj,rr,tJ,Zc,i7,I4,RO,Cq,xC,Pb,W9,O7,IU,E4,Gn,r7,Tz,Wk,DV,Hp,Nz,Jd,QS,hR,vY,b0,Dg,Ob,GV,Pg,fj,Ip,a9,YL,KC,xL,As,GE,ur,kP,uQ,D7,Zf,GS,VO,oP,kJ,em,VW,Mg,jN,Nt,Et,O4,Vv,yU,CF,JF,ZX,jr,Ws,ql,N2,uI,Vy,BW,ov,bW,PV,Cy,Y6,cv,uO,zx,h8,Un,rf,M1,SK,qf,oe,f6,uH,u9,QZ,IE,XE,If,Ew,tK,nh,wJ,W6,Md,YJ,AQ,AP,d7,aJ,wO,Go,Xk,ZK,of,Na,AQt,APl,d7T,aJg,wOs,GoD,Xke,ZKa,PY]}